...
include $pathInPieces[0].DIRECTORY_SEPARATOR . $pathInPieces[1].DIRECTORY_SEPARATOR . $pathInPieces[2].DIRECTORY_SEPARATOR . 'config.php';

session_start();
if (!isset($_SESSION['loggedin'])) {
    header("Location: $pathInPieces[0].DIRECTORY_SEPARATOR . $pathInPieces[1].DIRECTORY_SEPARATOR . $pathInPieces[2].DIRECTORY_SEPARATOR . 'login.php'");
    exit;
}
?>
